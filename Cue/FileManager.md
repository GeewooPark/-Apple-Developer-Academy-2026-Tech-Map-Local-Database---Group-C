...
출처 : https://developer.apple.com/documentation/foundation/filemanager
...
- Determining Access and Contents (접근 권한 및 콘텐츠 확인)
    `func fileExists(atPath: String) -> BoolReturns a Boolean value that indicates whether a file or directory exists at a specified path.`  
